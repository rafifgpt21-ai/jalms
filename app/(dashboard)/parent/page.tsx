...
export default function ParentDashboard() {
  return (
    <WorkspacePage>
      <MobileHeaderSetter title="Family dashboard" subtitle={format(new Date(), "EEEE, MMMM d")} />
      <WorkspacePanel className="flex min-h-56 items-center justify-center px-6 py-10 text-center">
