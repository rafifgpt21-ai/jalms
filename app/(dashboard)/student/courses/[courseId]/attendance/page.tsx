...
export default async function Page({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  return <WorkspacePage>
    <WorkspaceHeader><h1 className="text-xl font-semibold">Attendance</h1><p className="text-sm text-muted-foreground">{rate}% attendance across {counted.length} recorded sessions.</p></WorkspaceHeader>
