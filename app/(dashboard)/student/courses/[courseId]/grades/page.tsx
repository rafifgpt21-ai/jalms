...
export default async function Page({ params }: { params: Promise<{ courseId: string }> }) {
  ...
  return <WorkspacePage>
    <WorkspaceHeader><h1 className="text-xl font-semibold">Grades</h1><p className="text-sm text-muted-foreground">Current progress for {access.course.name}.</p></WorkspaceHeader>
