              ...
              <form action={dispatch} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" name="email" type="email" placeholder="name@school.edu" required autoComplete="email" autoFocus aria-invalid={Boolean(errorMessage)} className="h-12 rounded-xl bg-muted/35 pl-11 pr-4 shadow-none focus-visible:bg-background" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" name="password" type={showPassword ? "text" : "password"} required autoComplete="current-password" aria-invalid={Boolean(errorMessage)} className="h-12 rounded-xl bg-muted/35 pl-11 pr-12 shadow-none focus-visible:bg-background [&::-ms-clear]:hidden [&::-ms-reveal]:hidden" />
